...
.DATA
  MESSAGE1 DB '______________________________________________________________________________',0ah,0dh
         DB ' | |\_____\ |\__\    |\______\ |\______\                                      |',0ah,0dh
           DB ' | ||      |||   |   ||   _   |||  ___  |      ______                         |',0ah,0dh
           DB ' | ||  ____|||   |   ||  /|\  ||| |_/ | |     |\_____\   ___   _____   ____   |',0ah,0dh
           DB ' | || |__\  ||   |   || |__\| ||| |__/ /      ||  __  | |\__\ |\____\ |\____\ |',0ah,0dh
           DB ' | ||   __| ||   |_  ||  ___  |||   __/ ___   || |__| | ||   |||  _  |||  __ \|',0ah,0dh
           DB ' | ||  |    ||   |_\_||   |   |||  |   |\__\  ||  ___ \ ||   ||| |_/ ||| |  | |',0ah,0dh
           DB ' | ||  |    ||      |||   |   |||  |   \|___| || |___| |||   |||    < || |__| |',0ah,0dh
           DB ' | \|__|    \|______|\|___|___|\|__|          \|_______|\|___|\|_|\__\\|_____/|',0ah,0dh
  ...
  INSTRUCT  DB 'INSTRUCTIONS',0ah,0dh
        DB '------------------------------------------------------------------------------',0ah,0dh
        DB 'Press the arrow up Button to flap wings/fly. Avoid touching the obstacles, the',0ah,0dh
        DB 'upperbound of the screen and the lava to avoid dying. For every obstacle that ',0ah,0dh
        DB 'you avoid you will earn a point. Strive hard to beat the highscore!! And also,',0ah,0dh
        DB 'the speed increases as the game/your score progresses.',0ah,0dh
        DB ' ',0ah,0dh
        DB ' ',0ah,0dh
        DB 'Press ESC to return to menu... ',0ah,0dh,'$'
...
;---------------------------------------------
_SOUND PROC NEAR
                                              ;PRODUCES beep for each bounce of the ball
             MOV  AL, 182
             OUT 43H, AL
             MOV AX, 4304
            ;MOV AX, 3224
...
_SOUND1      PROC     NEAR                                          ;PRODUCES beep for each bounce of the ball
             MOV  AL, 182
             OUT 43H, AL
            ;MOV AX, 4304
             MOV AX, 3224
